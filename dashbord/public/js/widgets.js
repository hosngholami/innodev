(function () {
    ...
    var options = {
        series: [88, 85, 75, 60],
        labels: ["تحویل داده شد", "برگشت داده شد", "لغو شد", "در انتظار"],
        chart: {
            height: 218,
            type: 'radialBar',
        },
    ...
    var options1 = {
        series: [
          {
            name: "فروش",
            data: [144, 155, 141, 142, 122, 143, 121, 135, 156],
          },
          {
            name: "درامد",
            data: [133, 21, 32, 37, 123, 32, 47, 131, 54],
          },
          {
            name: "سود",
            data: [30, 125, 36, 30, 45, 135, 64, 51, 59],
          },
          {
            name: "هزینه",
            data: [30, 125, 36, 30, 45, 135, 64, 51, 59],
    ...
    var options = {
        series: [
            {
                name: "سفارشات",
                data: [24, 57, 55, 18, 44, 88, 65, 88, 66],
            },
            {
                name: "تحویل داده شده",
                data: [-8, -40, -15, -32, -45, -30, -20, -35, -28],
            },
            {
                name: "لغو شده",
                data: [18, 40, 32, 65, 45, 30, -20, 35, 28],
            }
        ],
        chart: {
            type: "line",
    ...
    var options = {
        ...
        labels: ['برنامه‌ها', 'آفلاین', 'وب‌سایت'],
    };

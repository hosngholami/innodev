                ...
                <div className="row">
                    <div className="col-lg-3 col-xs-6">
                        <div className="small-box bg-aqua">
                            ...
                            <a href="#" className="small-box-footer">اطلاعات بیشتر <i
                        ...
                        <div className="box box-info">
                            <div className="box-header">
                                ...
                                <div className="pull-left box-tools">
                                    <button type="button" className="btn bg-info btn-sm" data-widget="collapse"><i
                ...
                <div className="row">
                    <section className="col-lg-7 connectedSortable">
                        ...
                        <div className="box box-success">
                            ...
                            <div className="box-body chat" id="chat-box">
                                <div className="item">
                                    <img src="src/assets/admin/dist/img/user4-128x128.jpg" alt="user image"
                                        className="online" />

                                    <p className="message">
                                        <a href="#" className="name">
                                            <small className="text-muted pull-left"><i className="fa fa-clock-o"></i>
                                                2:15</small>
                                            نسترن
                                        </a>
                                        فایل مورد نظر شما
                                    ...
                                    <div className="attachment">
                                        ...
                                        <div className="pull-left">
                                            <button type="button"
                                                className="btn btn-primary btn-sm btn-flat">دانلود</button>
                                        </div>
                                    </div>
                                </div>
                                <div className="item">
                                    <img src="src/assets/admin/dist/img/user3-128x128.jpg" alt="user image"
                                        className="offline" />
                                ...
                                <div className="item">
                                    <img src="src/assets/admin/dist/img/user2-160x160.jpg" alt="user image"
                                        className="offline" />
                        ...
                        <div className="box box-primary">
                            ...
                            <div className="box-body">
                                <ul className="todo-list">
                                    <li>
                                        ...
                                        <small className="label label-danger"><i className="fa fa-clock-o"></i> ۲
                                            دقیقه</small>
                                        <div className="tools">
                                    ...
                                    <li>
                                        ...
                                        <small className="label label-info"><i className="fa fa-clock-o"></i> ۴
                                            ساعت</small>
                                        <div className="tools">
                                            <i className="fa fa-edit"></i>
                                            <i className="fa fa-trash-o"></i>
                                    ...
                                    <li>
                                        ...
                                        <small className="label label-warning"><i className="fa fa-clock-o"></i> ۱
                                            روز</small>
                                        <div className="tools">
                                            <i className="fa fa-edit"></i>
                                            <i className="fa fa-trash-o"></i>
                                    ...
                                    <li>
                                        ...
                                        <small className="label label-success"><i className="fa fa-clock-o"></i> ۳
                                            روز</small>
                                        <div className="tools">
                                            <i className="fa fa-edit"></i>
                                            <i className="fa fa-trash-o"></i>
                                    ...
                                    <li>
                                        ...
                                        <small className="label label-primary"><i className="fa fa-clock-o"></i> ۱
                                            هفته</small>
                                        <div className="tools">
                                            <i className="fa fa-edit"></i>
                                            <i className="fa fa-trash-o"></i>
                                    ...
                                    <li>
                                        ...
                                        <small className="label label-default"><i className="fa fa-clock-o"></i> ۲
                                            ماه</small>
                                        <div className="tools">
                                            <i className="fa fa-edit"></i>
                                            <i className="fa fa-trash-o"></i>
                            ...
                            <div className="box-footer clearfix no-border">
                                <button type="button" className="btn btn-default pull-left"><i
                                    className="fa fa-plus"></i> جدید</button>
                            </div>
                        </div>
                    ...
                    <section className="col-lg-5 connectedSortable">
                        ...
                        <div className="box box-solid bg-light-blue-gradient">
                            <div className="box-header">
                                <div className="pull-left box-tools">
                                    <button type="button" className="btn btn-primary btn-sm daterange pull-left"
                                        data-toggle="tooltip" title="Date range">
                                        <i className="fa fa-calendar"></i></button>
                                    <button type="button" className="btn btn-primary btn-sm pull-left"
                        ...
                        <div className="box box-solid bg-teal-gradient">
                            <div className="box-header">
                                ...
                                <div className="box-tools pull-left">
                                    ...
                                    <button type="button" className="btn bg-teal btn-sm" data-widget="remove"><i
                            ...
                            <div className="box-footer no-border">
                                <div className="row">
                                    <div className="col-xs-4 text-center" style={{borderLeft: '1px solid #f4f4f4'}}>
                                        <input type="text" className="knob" readOnly={true} defaultValue="20"
                                            data-width="60" data-height="60" />

                                        <div className="knob-label">سفارش ایمیلی</div>
                                    </div>
                                    <div className="col-xs-4 text-center" style={{borderLeft: '1px solid #f4f4f4'}}>
                                        <input type="text" className="knob" readOnly={true} defaultValue="50"
                                            data-width="60" data-height="60" />

                                        <div className="knob-label">سفارش آنلاین</div>
                                    </div>
                                    <div className="col-xs-4 text-center">
                                        <input type="text" className="knob" readOnly={true} defaultValue="30"
                                            data-width="60" data-height="60" />
